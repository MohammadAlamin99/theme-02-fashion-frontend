...
//   created_at: string;
//   updated_at: string;
//   banner_url: string | null; // ব্যাকএন্ডে এটিই মূল ফিল্ড
//   is_free_delivery: boolean;
//   discount_value: number;
//   min_order_amount: number;
//   // ব্যাকএন্ড findOne থেকে আসা ফ্ল্যাটেনড প্রোডাক্ট লিস্ট
//   products?: any[];
//   campaign_products?: { product_id: string; product?: { images?: string[] } }[];
// }
...
// /**
//  * FETCH SINGLE CAMPAIGN
//  * FIX: encodeURIComponent যোগ করা হয়েছে যাতে স্লাগের স্পেশাল ক্যারেক্টার সমস্যা না করে
//  */
// export const fetchCampaignByIdOrSlug = async (
//   idOrSlug: string,
// ): Promise<{ success: boolean; data: Campaign }> => {
//   const encoded = encodeURIComponent(idOrSlug);
//   const res = await apiFetch(`/campaigns/${encoded}`);
//   if (!res.ok) throw new Error("Campaign not found");
//   return res.json();
// };
...
//  * FETCH ACTIVE CAMPAIGNS
//  */
// export const fetchActiveCampaigns = async (): Promise<{ success: boolean; data: Campaign[] }> => {
//   const res = await apiFetch(`/campaigns/active`);
//   if (!res.ok) throw new Error("Failed to fetch active campaigns");
//   return res.json();
// };
...
// /**
//  * UPLOAD CAMPAIGN BANNER
//  * FIX: Typo ফিক্স করা হয়েছে (/upload-banner)
//  */
// export const uploadCampaignBanner = async (
//   file: File,
// ): Promise<BannerUploadResponse> => {
...
//   const res = await apiFetch("/campaigns/upload-banner", { // Fixed Typo
//     method: "POST",
//     body: formData,
//   });
