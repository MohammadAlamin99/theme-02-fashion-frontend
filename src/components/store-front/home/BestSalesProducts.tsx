...
const BestSalesProducts = ({ tags }: BestSalesProductsProps) => {
  ...
  return (
    <section className="w-full bg-[#F9F9F9] py-8 px-4 md:px-10 overflow-hidden font-inter">
      <div className="w-full">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <button className="best-prev cursor-pointer w-10 h-10 rounded-full border border-black flex items-center justify-center bg-white text-black transition-all hover:bg-black hover:text-white disabled:border-[#E2E2E2] disabled:text-[#E2E2E2] disabled:cursor-not-allowed">
              <FaChevronLeft className="text-xl" />
            </button>
            <button className="best-next cursor-pointer w-10 h-10 rounded-full border border-black flex items-center justify-center bg-white text-black transition-all hover:bg-black hover:text-white disabled:border-[#E2E2E2] disabled:text-[#E2E2E2] disabled:cursor-not-allowed">
              <FaChevronRight className="text-xl" />
            </button>
          </div>
        </div>
