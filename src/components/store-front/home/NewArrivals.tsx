      ...
      <div className="w-full">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            <button className="new-prev cursor-pointer w-10 h-10 rounded-full border border-black flex items-center justify-center bg-white text-black transition-all hover:bg-black hover:text-white disabled:border-[#E2E2E2] disabled:text-[#E2E2E2] disabled:cursor-not-allowed">
              <FaChevronLeft className="text-xl" />
            </button>
            <button className="new-next cursor-pointer w-10 h-10 rounded-full border border-black flex items-center justify-center bg-white text-black transition-all hover:bg-black hover:text-white disabled:border-[#E2E2E2] disabled:text-[#E2E2E2] disabled:cursor-not-allowed">
