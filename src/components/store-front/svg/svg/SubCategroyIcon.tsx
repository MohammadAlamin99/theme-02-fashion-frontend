interface SubCategroyIconProps {
    className?: string;
}

export default function SubCategroyIcon({ className }: SubCategroyIconProps) {
    return (
        <svg
        ...
        >
            ...
            <path d="M8.00002 18.5H21M16 5.5H8.00002M16.3235 7.67649L7.64868 16.3513" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
